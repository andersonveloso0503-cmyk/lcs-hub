  ...
  try {
    ...
    for (let i = 0; i < posts.length; i++) {
      ...
      try {
        ...
        // Gera a imagem e AGENDA direto no Buffer (Instagram) — sem esperar
        // aprovação manual. O registro no Firestore fica como histórico/log,
        // com o status refletindo se o agendamento no Buffer deu certo.
